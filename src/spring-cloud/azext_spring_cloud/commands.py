...
from ._client_factory import (cf_app_services,
                              ...
                              cf_spring_cloud_enterprise_or_stable,
                              cf_spring_cloud_20201101preview,
                              cf_spring_cloud_20210901preview,
                              cf_spring_cloud_enterprise_or_20210901preview,
                              cf_config_servers)
...
def load_command_table(self, _):
    ...
    with self.command_group('spring-cloud', client_factory=cf_spring_cloud_enterprise_or_stable,
        ...
        g.custom_command('stop', 'spring_cloud_stop', supports_no_wait=True, client_factory=cf_spring_cloud_enterprise_or_20210901preview)
    ...
    with self.command_group('spring-cloud test-endpoint', client_factory=cf_spring_cloud_enterprise_or_stable,
                            exception_handler=handle_asc_exception) as g:
    ...
    with self.command_group('spring-cloud app identity', client_factory=cf_spring_cloud_enterprise_or_stable,
                            exception_handler=handle_asc_exception) as g:
    ...
    with self.command_group('spring-cloud app log', client_factory=cf_spring_cloud_enterprise_or_stable,
    ...
    with self.command_group('spring-cloud app deployment', client_factory=cf_spring_cloud_enterprise_or_20210901preview,
                            exception_handler=handle_asc_exception) as g:
    ...
    with self.command_group('spring-cloud app binding', client_factory=cf_spring_cloud_enterprise_or_stable,
                            exception_handler=handle_asc_exception) as g:
    ...
    with self.command_group('spring-cloud storage', client_factory=cf_spring_cloud_enterprise_or_20210901preview,
                            exception_handler=handle_asc_exception) as g:
    ...
    with self.command_group('spring-cloud certificate', client_factory=cf_spring_cloud_enterprise_or_20210901preview,
                            exception_handler=handle_asc_exception) as g:
    ...
    with self.command_group('spring-cloud app custom-domain', client_factory=cf_spring_cloud_enterprise_or_stable,
                            exception_handler=handle_asc_exception) as g:
