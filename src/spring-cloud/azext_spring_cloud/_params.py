...
def load_arguments(self, _):
    ...
    with self.argument_context('spring-cloud application-configuration-service git repo add') as c:
        c.argument('name',
                   help="Required unique name to label each git repository.")
        c.argument('patterns',
    ...
    with self.argument_context('spring-cloud application-configuration-service git repo update') as c:
        c.argument('name',
                   help="Required unique name to label each git repository."),
        c.argument('patterns',
                   help="Required patterns used to search in Git repositories. For each pattern, use format like {application} or {application}/{profile} instead of {application}-{profile}.yml, and separate them by comma."),
    ...
    with self.argument_context('spring-cloud application-configuration-service git repo remove') as c:
        c.argument('name', help="Required unique name to label each git repository.")
