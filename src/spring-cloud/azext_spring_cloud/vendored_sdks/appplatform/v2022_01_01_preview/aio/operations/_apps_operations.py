...
class AppsOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.mgmt.appplatform.v2022_01_01_preview.models.AppResource
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type app_resource: ~azure.mgmt.appplatform.v2022_01_01_preview.models.AppResource
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.v2022_01_01_preview.models.AppResourceCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def _set_active_deployments_initial(
        ...
        **kwargs: Any
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(active_deployment_collection, 'ActiveDeploymentCollection')
        body_content_kwargs['content'] = body_content
