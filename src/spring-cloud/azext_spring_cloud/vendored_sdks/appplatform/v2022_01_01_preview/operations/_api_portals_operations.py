...
class ApiPortalsOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.ApiPortalResource"
        ...
        :rtype: ~azure.mgmt.appplatform.v2022_01_01_preview.models.ApiPortalResource
        ...
        path_format_arguments = {
            ...
            'apiPortalName': self._serialize.url("api_portal_name", api_portal_name, 'str'),
        }
    ...
    def _create_or_update_initial(
        ...
        service_name,  # type: str
        api_portal_name,  # type: str
        api_portal_resource,  # type: "_models.ApiPortalResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.ApiPortalResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ApiPortalResource"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.ApiPortalResource"]
        ...
        :return: An instance of LROPoller that returns either ApiPortalResource or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2022_01_01_preview.models.ApiPortalResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.ApiPortalResourceCollection"]
        ...
        :type service_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ApiPortalResourceCollection or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2022_01_01_preview.models.ApiPortalResourceCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.ApiPortalResourceCollection"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/apiPortals'}  # type: ignore
