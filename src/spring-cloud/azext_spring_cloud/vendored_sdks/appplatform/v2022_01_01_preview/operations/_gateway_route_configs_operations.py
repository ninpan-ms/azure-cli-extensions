...
class GatewayRouteConfigsOperations(object):
    ...
    def get(
        ...
        route_config_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.GatewayRouteConfigResource"
        ...
        :rtype: ~azure.mgmt.appplatform.v2022_01_01_preview.models.GatewayRouteConfigResource
        ...
        path_format_arguments = {
            ...
            'routeConfigName': self._serialize.url("route_config_name", route_config_name, 'str'),
        }
    ...
    def _create_or_update_initial(
        ...
        gateway_name,  # type: str
        route_config_name,  # type: str
        gateway_route_config_resource,  # type: "_models.GatewayRouteConfigResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.GatewayRouteConfigResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.GatewayRouteConfigResource"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.GatewayRouteConfigResource"]
        ...
        :return: An instance of LROPoller that returns either GatewayRouteConfigResource or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2022_01_01_preview.models.GatewayRouteConfigResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.GatewayRouteConfigResourceCollection"]
        ...
        :type gateway_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either GatewayRouteConfigResourceCollection or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2022_01_01_preview.models.GatewayRouteConfigResourceCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
