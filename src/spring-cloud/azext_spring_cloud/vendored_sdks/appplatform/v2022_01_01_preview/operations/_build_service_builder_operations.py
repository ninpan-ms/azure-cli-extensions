...
class BuildServiceBuilderOperations(object):
    ...
    def get(
        ...
        builder_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.BuilderResource"
        """Get a KPack builder.
        ...
        :rtype: ~azure.mgmt.appplatform.v2022_01_01_preview.models.BuilderResource
        ...
        path_format_arguments = {
            ...
            'builderName': self._serialize.url("builder_name", builder_name, 'str'),
        }
    ...
    def _create_or_update_initial(
        ...
        build_service_name,  # type: str
        builder_name,  # type: str
        builder_resource,  # type: "_models.BuilderResource"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.BuilderResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["_models.BuilderResource"]
        ...
        body_content = self._serialize.body(builder_resource, 'BuilderResource')
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> LROPoller["_models.BuilderResource"]
        ...
        :type builder_resource: ~azure.mgmt.appplatform.v2022_01_01_preview.models.BuilderResource
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of LROPoller that returns either BuilderResource or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.appplatform.v2022_01_01_preview.models.BuilderResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.BuilderResourceCollection"]
        ...
        :type build_service_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either BuilderResourceCollection or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.appplatform.v2022_01_01_preview.models.BuilderResourceCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
