...
class BuildServiceOperations:
    ...
    async def create_or_update_build(
        ...
        **kwargs: Any
        ...
        return deserialized
    create_or_update_build.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/buildservices/default/builds/{buildName}'}  # type: ignore
    ...
    async def get_build_result(
        ...
        **kwargs: Any
        ...
        return deserialized
    get_build_result.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/buildservices/default/builds/{buildName}/results/{buildResultName}'}  # type: ignore
