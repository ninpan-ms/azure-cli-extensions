...
class ConfigurationServiceGitPropertyValidateResult(msrest.serialization.Model):
    ...
    :type git_repos_validate_result:
     list[~azure.mgmt.appplatform.v2022_05_01_preview.models.ValidateMessages]
    """
    ...
    def __init__(
        ...
        *,
        is_valid: Optional[bool] = None,
        git_repos_validate_result: Optional[List["ValidateMessages"]] = None,
        **kwargs
    ):
...
class ConfigurationServiceSettings(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        git_properties: Optional[List["GitPatternRepository"]] = None,
        **kwargs
    ):
...
class ValidateMessages(msrest.serialization.Model):
