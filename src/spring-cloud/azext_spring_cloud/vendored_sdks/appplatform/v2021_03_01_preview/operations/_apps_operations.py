...
class AppsOperations(object):
    ...
    def get(
            self, resource_group_name, service_name, app_name, sync_status=None, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~azure.mgmt.appplatform.v2021_03_01_preview.models.AppResource
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('AppResource', response)
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Tanzu/{serviceName}/apps/{appName}'}
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.appplatform.v2021_03_01_preview.models.AppResource]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.appplatform.v2021_03_01_preview.models.AppResource]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Tanzu/{serviceName}/apps/{appName}'}
    ...
    def delete(
            self, resource_group_name, service_name, app_name, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Tanzu/{serviceName}/apps/{appName}'}
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.appplatform.v2021_03_01_preview.models.AppResourcePaged[~azure.mgmt.appplatform.v2021_03_01_preview.models.AppResource]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Tanzu/{serviceName}/apps'}
