...
class DeploymentsOperations(object):
    ...
    def get(
        ...
        :rtype:
         ~azure.mgmt.appplatform.v2021_03_01_preview.models.DeploymentResource
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Tanzu/{serviceName}/apps/{appName}/deployments/{deploymentName}'}
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.appplatform.v2021_03_01_preview.models.DeploymentResource]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.appplatform.v2021_03_01_preview.models.DeploymentResource]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Tanzu/{serviceName}/apps/{appName}/deployments/{deploymentName}'}
    ...
    def delete(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Tanzu/{serviceName}/apps/{appName}/deployments/{deploymentName}'}
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.appplatform.v2021_03_01_preview.models.DeploymentResourcePaged[~azure.mgmt.appplatform.v2021_03_01_preview.models.DeploymentResource]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Tanzu/{serviceName}/apps/{appName}/deployments'}
    ...
    def list_for_cluster(
        ...
        return deserialized
    list_for_cluster.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Tanzu/{serviceName}/deployments'}
    ...
    def start(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    start.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Tanzu/{serviceName}/apps/{appName}/deployments/{deploymentName}/start'}
    ...
    def stop(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    stop.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Tanzu/{serviceName}/apps/{appName}/deployments/{deploymentName}/stop'}
    ...
    def restart(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    restart.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Tanzu/{serviceName}/apps/{appName}/deployments/{deploymentName}/restart'}
    ...
    def _deploy_initial(
        ...
        # Construct body
        body_content = self._serialize.body(deployment_deploy_request, 'UserSourceInfo')
    ...
    def deploy(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    deploy.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Tanzu/{serviceName}/apps/{appName}/deployments/{deploymentName}/deploy'}
