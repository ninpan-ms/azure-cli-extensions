...
class BuildServiceOperations(object):
    ...
    def get_upload_url(
        ...
        """Get an resource upload URL for an build service, which may be artifacts
        or source archive.
        ...
        :rtype:
         ~azure.mgmt.appplatform.v2021_03_01_preview.models.ResourceUploadDefinition
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
        url = self.get_upload_url.metadata['url']
        ...
        return deserialized
    get_upload_url.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Tanzu/{serviceName}/buildservice/default/getUploadUrl'}

    def create_or_update_build(
            self, resource_group_name, service_name, build_name, properties=None, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~azure.mgmt.appplatform.v2021_03_01_preview.models.Build or
        ...
        # Construct URL
        url = self.create_or_update_build.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'serviceName': self._serialize.url("service_name", service_name, 'str'),
        ...
        return deserialized
    create_or_update_build.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Tanzu/{serviceName}/buildservice/default/builds/{buildName}'}

    def get_build_result(
            self, resource_group_name, service_name, build_name, build_result_name, custom_headers=None, raw=False, **operation_config):
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: BuildResult or ClientRawResponse if raw=true
        :rtype: ~azure.mgmt.appplatform.v2021_03_01_preview.models.BuildResult
         or ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
        url = self.get_build_result.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'serviceName': self._serialize.url("service_name", service_name, 'str'),
        ...
        deserialized = None
        if response.status_code == 200:
            deserialized = self._deserialize('BuildResult', response)
