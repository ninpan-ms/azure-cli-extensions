...
from .vendored_sdks.appplatform.v2021_03_01_preview import AppPlatformManagementClient as AppPlatformManagementClient_20210301preview
...
def cf_tanzu(cli_ctx, *_):
    return get_mgmt_service_client(cli_ctx, AppPlatformManagementClient_20210301preview)
